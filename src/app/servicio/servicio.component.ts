...
declare const $: any;
declare const SIN_DATOS = 'Búsqueda sin resultados';
...
export class ServicioComponent implements OnInit {
  ...
  /*-------------------------------------------------------------------------*/
  /*-------------------------------------------------------------------------*/
  agregarServicio(rowChecked, a) {
    console.log('click en AGREGAR SERVICIO: ', rowChecked);
    console.log('click en AGREGAR SERVICIO:a ', a);
  }
  /*-------------------------------------------------------------------------*/
